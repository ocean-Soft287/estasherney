...
import 'package:consult_me/doctor/home/presentation/screens/homeview/presentation/screens/available_online.dart';
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => AvailableOnline()),
                      );
                    },
                    child: Container(
                      padding: EdgeInsets.all(screenWidth * 0.025),
