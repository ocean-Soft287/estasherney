...
import 'package:consult_me/doctor/privacy/presentation/screens/privacy_two_doctor.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:google_fonts/google_fonts.dart';

class PrivacyOneDoctor extends StatefulWidget {
  final LoginModel user;
  const PrivacyOneDoctor({super.key,  required this.user});

  @override
  State<PrivacyOneDoctor> createState() => _PrivacyOneDoctorState();
}

class _PrivacyOneDoctorState extends State<PrivacyOneDoctor> with TickerProviderStateMixin {
                  ...
                  DefaultButton(
                    ...
                    function: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PageTwoDoctorPrivacy(user: widget.user,),
                        ),
                      );
                    },
                  ),
