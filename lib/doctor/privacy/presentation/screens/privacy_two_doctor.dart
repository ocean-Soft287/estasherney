...
class PageTwoDoctorPrivacy extends StatefulWidget {
  final LoginModel user ;
  const PageTwoDoctorPrivacy({super.key, required this.user});

  @override
  State<PageTwoDoctorPrivacy> createState() => _PageTwoDoctorPrivacyState();
}

class _PageTwoDoctorPrivacyState extends State<PageTwoDoctorPrivacy>
                  ...
                  DefaultButton(
                    ...
                    function: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => HomeScreenDoctor(user:widget.user ,),
                        ),
                      );
                    },
                  ),
