...
class DoctorAllRatingRepoImpl implements DoctorAllRatingRepo {
  final DioConsumer dioConsumer;

  DoctorAllRatingRepoImpl(this.dioConsumer);

  @override
  Future<Either<Failure, DoctorAllModel>> getDoctorRatings(int doctorId) async {
    try {
      final response = await dioConsumer.get(
        EndPoint.getAllRatings(doctorId),
        queryParameters: {'doctorId': doctorId.toString()},
      );

      return Right(DoctorAllModel.fromJson(response));
    } catch (e) {
