...
import '../../../core/Network/local/sharedprefrences.dart';
import '../data/localizationmodel.dart';
    ...
    try {
      switch (eventType) {
        ...
        // Try to get the language from shared preferences
          ...
          print("Current Language: ${state is ChangeLanguage ? (state as ChangeLanguage).languageCode : 'Unknown'}");
          break;
