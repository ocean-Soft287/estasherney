              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoRow(
                    ...
                    label: 'المدة ',
                    value: '${dayDetail.consultationDurationMinutes ?? 0} دقيقة',
                  ),
                  SizedBox(height: 16.h),
                  Text(
                    'الاوقات المتاحة',
        ...
        return   GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${slot.startTime} - ${slot.endTime} ${slot.isSelected! ? '(تم حجز الموعد)' : ''}',
                  style: GoogleFonts.leagueSpartan(
                    fontSize: 12.sp,
                    fontWeight: FontWeight.bold,
